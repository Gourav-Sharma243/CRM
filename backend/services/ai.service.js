...
export const generateLeadEmail = async (lead, purpose,tone,sender) => {
    ...
    Use line breaks(\\n) in the body. Keep it under 180 word. Sign off as 
...
export const generateSalesInsights = async (pipelineStats) => {
    ...
    sales pipeline, identify what is working, what is at risk, and concrete actions to imporve conversation.
